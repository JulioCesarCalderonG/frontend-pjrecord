...
import { CondicionService } from 'src/app/servicios/condicion.service';
import { PersonalService } from 'src/app/servicios/personal.service';
import { RegimenLaboralService } from 'src/app/servicios/regimen-laboral.service';
import { RegimenService } from 'src/app/servicios/regimen.service';
...
export class RegimenLaboralComponent implements OnInit {
  ...
  agregarRegimenLaboral(){
    ...
    body.append('id_condicion',this.regimenLaborarForm.get('id_condicion')?.value);
    body.append('id_personal',this.regimenLaborarForm.get('id_personal')?.value);
    body.append('id_tipo_personal',this.regimenLaborarForm.get('id_tipo_personal')?.value);
  ...
  editarRegimenLaboral(){
    const body = new FormData();
    body.append('id_condicion',this.regimenLaborarEditarForm.get('id_condicion')?.value);
    body.append('id_personal',this.regimenLaborarEditarForm.get('id_personal')?.value);
    body.append('id_tipo_personal',this.regimenLaborarEditarForm.get('id_tipo_personal')?.value);
    ...
    this.regimenLaboralService.putRegimenlaboral(body,this.idRegimenLaboral).subscribe(
      (data)=>{
